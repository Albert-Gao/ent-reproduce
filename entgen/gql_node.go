...
func (pr *Profile) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(pr.NickName); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(pr.OwnerID); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(pr.TenantID); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
