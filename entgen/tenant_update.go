...
func (tu *TenantUpdate) AddMemberIDs(ids ...string) *TenantUpdate {
	tu.mutation.AddMemberIDs(ids...)
	return tu
}

// AddMembers adds the "members" edges to the User entity.
func (tu *TenantUpdate) AddMembers(u ...*User) *TenantUpdate {
...
func (tu *TenantUpdate) AddMemberProfileIDs(ids ...string) *TenantUpdate {
	tu.mutation.AddMemberProfileIDs(ids...)
	return tu
}

// AddMemberProfiles adds the "memberProfiles" edges to the Profile entity.
func (tu *TenantUpdate) AddMemberProfiles(p ...*Profile) *TenantUpdate {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return tu.AddMemberProfileIDs(ids...)
}
...
func (tu *TenantUpdate) RemoveMemberIDs(ids ...string) *TenantUpdate {
	tu.mutation.RemoveMemberIDs(ids...)
	return tu
}

// RemoveMembers removes "members" edges to User entities.
func (tu *TenantUpdate) RemoveMembers(u ...*User) *TenantUpdate {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// ClearMemberProfiles clears all "memberProfiles" edges to the Profile entity.
func (tu *TenantUpdate) ClearMemberProfiles() *TenantUpdate {
	tu.mutation.ClearMemberProfiles()
	return tu
}

// RemoveMemberProfileIDs removes the "memberProfiles" edge to Profile entities by IDs.
func (tu *TenantUpdate) RemoveMemberProfileIDs(ids ...string) *TenantUpdate {
	tu.mutation.RemoveMemberProfileIDs(ids...)
	return tu
}

// RemoveMemberProfiles removes "memberProfiles" edges to Profile entities.
func (tu *TenantUpdate) RemoveMemberProfiles(p ...*Profile) *TenantUpdate {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return tu.RemoveMemberProfileIDs(ids...)
}
...
func (tu *TenantUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.MemberProfilesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := tu.mutation.RemovedMemberProfilesIDs(); len(nodes) > 0 && !tu.mutation.MemberProfilesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tenant.MemberProfilesTable,
	...
	if nodes := tu.mutation.MemberProfilesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tenant.MemberProfilesTable,
...
// AddMemberIDs adds the "members" edge to the User entity by IDs.
func (tuo *TenantUpdateOne) AddMemberIDs(ids ...string) *TenantUpdateOne {
	tuo.mutation.AddMemberIDs(ids...)
	return tuo
}

// AddMembers adds the "members" edges to the User entity.
func (tuo *TenantUpdateOne) AddMembers(u ...*User) *TenantUpdateOne {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// AddMemberProfileIDs adds the "memberProfiles" edge to the Profile entity by IDs.
func (tuo *TenantUpdateOne) AddMemberProfileIDs(ids ...string) *TenantUpdateOne {
	tuo.mutation.AddMemberProfileIDs(ids...)
	return tuo
}

// AddMemberProfiles adds the "memberProfiles" edges to the Profile entity.
func (tuo *TenantUpdateOne) AddMemberProfiles(p ...*Profile) *TenantUpdateOne {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return tuo.AddMemberProfileIDs(ids...)
}
...
// RemoveMemberIDs removes the "members" edge to User entities by IDs.
func (tuo *TenantUpdateOne) RemoveMemberIDs(ids ...string) *TenantUpdateOne {
	tuo.mutation.RemoveMemberIDs(ids...)
	return tuo
}

// RemoveMembers removes "members" edges to User entities.
func (tuo *TenantUpdateOne) RemoveMembers(u ...*User) *TenantUpdateOne {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// ClearMemberProfiles clears all "memberProfiles" edges to the Profile entity.
func (tuo *TenantUpdateOne) ClearMemberProfiles() *TenantUpdateOne {
	tuo.mutation.ClearMemberProfiles()
	return tuo
}

// RemoveMemberProfileIDs removes the "memberProfiles" edge to Profile entities by IDs.
func (tuo *TenantUpdateOne) RemoveMemberProfileIDs(ids ...string) *TenantUpdateOne {
	tuo.mutation.RemoveMemberProfileIDs(ids...)
	return tuo
}

// RemoveMemberProfiles removes "memberProfiles" edges to Profile entities.
func (tuo *TenantUpdateOne) RemoveMemberProfiles(p ...*Profile) *TenantUpdateOne {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return tuo.RemoveMemberProfileIDs(ids...)
}
...
func (tuo *TenantUpdateOne) sqlSave(ctx context.Context) (_node *Tenant, err error) {
	...
	if tuo.mutation.MemberProfilesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tenant.MemberProfilesTable,
	...
	if nodes := tuo.mutation.RemovedMemberProfilesIDs(); len(nodes) > 0 && !tuo.mutation.MemberProfilesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tenant.MemberProfilesTable,
	...
	if nodes := tuo.mutation.MemberProfilesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tenant.MemberProfilesTable,
